...
export default function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center overflow-hidden bg-black px-4 text-white">
      ...
      <div className="z-10 w-full max-w-7xl py-12 md:py-20">
        {/* 히어로 섹션 */}
        ...
        {/* 보안 강조 */}
        <div className="mb-24 flex flex-col items-center rounded-3xl border border-violet-400/30 bg-violet-900/20 p-8 text-center shadow-[0_0_40px_rgba(139,92,246,0.1)]">
        ...
        {/* 🔥 환율 정보 및 로비 채팅 위젯 */}
        <div className="flex flex-col gap-12 w-full max-w-5xl mx-auto relative z-20 mb-24">
